...
function Icons() {
      ...
      Cell: row => (
        <div className="flex items-center">
          <IconButton
            onClick={ev => {
              ev.stopPropagation();
              dispatch(Action.Author.AuthorAction.deleteAuthor(row.original.id));
            }}
          >
            <Icon>delete</Icon>
          </IconButton>
  ...
  useEffect(()=>{
    pagging&&dispatch(Action.Author.AuthorsAction.changeCriteria({...criteria,pageIndex:pagging.pageIndex,pageSize:pagging.pageSize}));
  },[pagging])
  return (
    <>
      <Header />
            ...
            <Card className="shadow">
              ...
              <ReactTable
                ...
                onFetchData={(state, instance) => {
                  setPagging({ pageIndex: state.page, pageSize: state.pageSize });
                }}
