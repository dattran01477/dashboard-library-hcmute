import * as Author from "../views/author/store/action";
import * as Category from "../views/category/store/action";
...
import * as Book from "../views/book/store/action/book.action";
